...
#------------------------------------------------------------------------------------------------------------------------------------------------
#'@title Load data
#' @description Function that finds our data and converts Json to normal readable string --> used at beginning of application to get df
...
#------------------------------------------------------------------------------------------------------------------------------------------------
#'@title Daily Movie
#'@description Finding a daily movie by choosing randomly based on seed fixed on date --> for PeliDaily tab
...
#'@description We are making the function that recommends a movie based on our criteria --> For PeliSearch Tab
...
#------------------------------------------------------------------------------------------------------------------------------------------------
#'@title Random Movie
#'@description Now we want to make another function that selects a film at random form this list that we generated from the function above --> for PeliRecommend Tab
...
#------------------------------------------------------------------------------------------------------------------------------------------------
#'@title Movie Search
#'@description  We are making a function that gives us the desired researched data --> For PeliSearch tab
...
#-----------------------------------------------------------------------------------------------------------------------------------------------
#'@title Movie Plot
#'@description # We make a function that will create a desired plot -> For the PeliData Tab
