...
data_recommend = function(df, genre_1, genre_2, vote_average_input, popularity_input, date_before, 
                       date_after, runtime_input, original_language_input, spoken_languages_input, production_country_input){
...
#------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  data_search = function(df, title_input, key_input){
    
    movies_search = df %>% 
        filter(grepl(pattern = title_input, x = title)) %>%
        filter(grepl(pattern = key_input, x = keywords)) %>%
